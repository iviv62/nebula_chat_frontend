        ...
        <main class="landing-main">
          <section class="hero-section">
            <div class="version-badge">
              <span class="dot"></span> Nebula v2.0 is now live
            </div>
            ...
            <div class="top-row">
              <div class="feature-card main-feature">
                <div class="card-header">
                  <span class="hashtag">#</span> design-discussions
                </div>
                     ...
                     <div class="mockup-main">
                       ...
                       <div class="mockup-avatar-large">
                         <svg width="64" height="64" viewBox="0 0 64 64" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                           <circle cx="32" cy="32" r="28" stroke="currentColor" opacity="0.3"></circle>
                ...
                <div class="card-footer">
                  <svg class="plus-icon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
